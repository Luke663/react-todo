...
This project is a React to-do application that was done to learn more about JavaScript and React with this [YouTube tutorial](https://www.youtube.com/watch?v=Rh3tobg7hEo&t=1s) from the channel _Web Dev Simplified_. The user can add, remove, and check off to-do items that are saved to local storage for persistance between uses.
